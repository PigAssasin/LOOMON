-- Keep seller/buyer order workspaces production-ready:
-- order rows must carry the original buyer note and requested date.
    ...
    when lower(p_wallet_address) <> '0xd59aa8db407d4219fe4b104ca4142df14301dec4'
      ...
      'sellingOrders', coalesce((
        ...
        from (
          ...
          join commerce.quote_requests request
            on request.id = quote_version.quote_request_id
